...
internal object ReceiptEmailComposer {
    ...
    fun compose(content: ReceiptContent, pdf: File): InvoiceExportResult {
        ...
        val htmlBody = content.formatReceiptEmailHtmlBody()
        val plainBody = content.formatReceiptEmailPlainTextBody()
    ...
    private inline fun <T> withTempEmailFiles(
        ...
        val htmlFile = File.createTempFile("glide-receipt-", ".html")
        val plainFile = File.createTempFile("glide-receipt-", ".txt")
    ...
    private fun receiptEmailSubject(content: ReceiptContent): String =
        "Receipt ${content.receiptNumber} from ${content.fromName}"
}
